package com.fudan.certserver.test;
...
*/
    ...
    static String student_attr = "a:1 b:2 c:3";

    static String student_policy = "a:1 a:2 a:3 1of3";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String prvkey = Cpabe.keygen_nofile(pubfile,mskfile,attr_str);
        System.out.println("prvkey is :"+prvkey);
        println("//end to keygen");

        println("//start to enc");
        String cert="   证书    : 测试  ， , fudan  | ";
        String aesCert=Cpabe.enc_nofile(pubfile, policy,cert);
        println("//end to enc");

        println("//start to dec");
        //test.dec(pubfile, prvfile, aesCert);
        Cpabe.dec_nofile(pubfile,prvkey,aesCert);
        println("//end to dec");
    }
